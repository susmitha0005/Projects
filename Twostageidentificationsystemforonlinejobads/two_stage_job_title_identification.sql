...
--
-- Host: localhost
-- Generation Time: Sep 13, 2023 at 08:20 AM
...
--
-- Database: `two_stage_job_title_identification`
--
CREATE DATABASE IF NOT EXISTS `two_stage_job_title_identification` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `two_stage_job_title_identification`;
...
('l77rx4iue81yi18pkut0l8uiuwce2f51', 'eyJ1c2VyaWQiOjF9:1qd9nA:F2FHvw4u_QNt_VmdVOlOWURtCfWtd9Xb9oHEop2YmkY', '2023-09-18 13:39:00.438406'),
...
('r044b1u58xszqmyei6s1ij26ofq3fd81', 'eyJ1c2VyaWQiOjR9:1qdAtx:JM9VzVQNLu4jQKdKIG1SOUCnAcLFNttja6ETdvmm3Dk', '2023-09-18 14:50:05.178285'),
...
(1, 'Gokulnath', 'Gokulnath123@gmail.com', 'Gokulnath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Rajajinagar', 'Male'),
...
(4, 'Amarnath', 'Amarnath123@gmail.com', 'Amarnath', '9535866270', 'India', 'karnataka', 'Bangalore', '#8928,4th Cross,Rajajinagar', 'Male');
...
(15, 'KNeighborsClassifier', '89.70297029702971'),
(16, 'SVM', '93.26732673267327'),
(17, 'Logistic Regression', '94.25742574257426'),
(18, 'Gradient Boosting Classifier', '93.66336633663367'),
(19, 'Artificial Neural Network (ANN)', '93.26732673267327');
...
(17, 'Software Development', '75.0'),
(18, 'Others', '25.0');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_job_title_identification`
--

CREATE TABLE IF NOT EXISTS `remote_user_job_title_identification` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `joblocation_address` varchar(300) NOT NULL,
  `numberofpositions` varchar(300) NOT NULL,
  `payrate` varchar(300) NOT NULL,
  `postdate` varchar(300) NOT NULL,
...
--
-- Dumping data for table `remote_user_job_title_identification`
--

INSERT INTO `remote_user_job_title_identification` (`id`, `company`, `education`, `experience`, `industry`, `jobdescription`, `jobid`, `joblocation_address`, `numberofpositions`, `payrate`, `postdate`, `skills`, `Prediction`) VALUES
(1, 'Kinesis Management Consultant Pvt. Ltd', 'UG: Diploma - Any Specialization, Electrical, Electronics/Telecommunication', '1 - 3 yrs', 'IT-Software / Software Services', 'Job Description Â  Send me Jobs like this experience/strong knowledge in PHP web application development Develop and maintain new features on Web Application development & LAMP stack Handson experience in PHP, Perl, Python, MySQL, JQuery, Ajax is must. Strong in OOPS and must have worked in Salary:INR 3,00,000 - 6,50,000 P.A Industry: IT-Software / Software Services Functional Area: IT Software - Application Programming , Maintenance Role Category:Programming & Design Role:Software Developer Keyskills LAMP PHP MySQL JQuery Ajax Python OOPS Web Application Development Perl Web Technologies Web Services struts asp.net xml soap webservices shampoo Desired Candidate Profile Working experience in any of the APIs like Facebook, Twitter or Google would be added advantage Create highly efficient and dynamic PHP code Familiar with JavaScript frameworks like Angular, React, Ember and/or Backbone Troubleshoot, test and mainta Company Profile: Kinesis Management Consultant Pvt. Ltd Large It Company , Design, develop, maintain and optimize secure and scalable web applications in all phases of the development life cycle Analyze requirements and develop application designs, Download PPT Photo 1 Â  View Contact Details\r\n', '131016004451', 'Delhi NCR, Mumbai, Bengaluru, Kochi, Greater Noida, Gurgaon, Hyderabad, Kozhikode, Lucknow', '2', '3,00,000 - 6,50,000 P.A', '2022-10-13 16:20:55 +0000', 'IT Software - Application Programming', 'Software Development'),
(2, 'HumanKonnect', 'UG: Any Graduate - Any Specialization PG:MBA/PGDM - Marketing Doctorate:Doctorate Not Required', '6 - 10 yrs', 'Insurance', 'Job Description Â  Send me Jobs like this Drive & manage all digital campaigns for lead generation & awareness creation. Manage company''s online presence in order to engage with prospects & existing customers. Develop & Manage Corporate Website by using new technologies Salary: Not Disclosed by Recruiter Industry: Insurance Functional Area: Marketing , Advertising , MR , PR , Media Planning Role Category:Online/Digital Marketing Role:Social Media Marketing Manager Keyskills Senior Manager Deputy General Manager Digital Marketing Marketing Campaign management online marketing Desired Candidate Profile Qualification -MBA ''Marketing'' Education- UG: Any Graduate - Any Specialization PG:MBA/PGDM - Marketing Doctorate:Doctorate Not Required Company Profile: HumanKonnect Leading client of HumanKonnect Download PPT Photo 1 Â  View Contact Details\r\n', '51016900668', 'Bengaluru', '3', 'Not Disclosed by Recruiter', '2022-10-13 16:20:56 +0000', 'Marketing', 'Others'),
(3, 'Confidential', 'UG: Any Graduate - Any Specialization PG:Any Postgraduate Doctorate:Doctorate Not Required', '9 - 12 yrs', 'IT-Software / Software Services', 'Job Description Â  Send me Jobs like this - Hands-on experience on Object Oriented Java script (OOJS) . - Having worked on Angular.js / BackboneJS, UnderscoreJS, RequireJS / Node.JS - Experience in HTML, CSS is highly desirable. - Hands-on experience on Object Oriented Java script (OOJS) . - Having worked on Angular.js / BackboneJS, UnderscoreJS, RequireJS / Node.JS - Experience in HTML, CSS is highly desirable. Must have : - Object Oriented JavaScript - Javascript - Angular.js - HTML 5 - CSS 2.1 and higher - JSON - Knowledge of JavaScript design patterns Job Responsibilities : - Interactive Development - Multi-Discipline interaction - IA / Creative - Provide insight and feedback to Information Architects and Designers for usability and feasibility of interface designs. Salary: Not Disclosed by Recruiter Industry: IT-Software / Software Services Functional Area: IT Software - Application Programming , Maintenance Role Category:Programming & Design Role:Software Developer Keyskills HTML Javascript CSS JSON Java Design Patterns Usability Angular.js BackboneJS UnderscoreJS RequireJS Node.JS Desired Candidate Profile Â  Education- UG: Any Graduate - Any Specialization PG:Any Postgraduate Doctorate:Doctorate Not Required Company Profile: Confidential Confidential Download PPT Photo 1 Â  View Contact Details\r\n', '10816900754', 'Delhi NCR, Bengaluru', '5', 'Not Disclosed by Recruiter', '2022-10-13 16:20:56 +0000', 'IT Software - Application Programming', 'Software Development'),
(4, 'Sinai Global', 'UG: B.Tech/B.E. - Any Specialization, Diploma - Any Specialization PG:Post Graduation Not Required Doctorate:Doctorate Not Required', '2 - 4 yrs', 'IT-Software / Software Services', 'Job Description Â  Send me Jobs like this We are looking for a skilled and passionate Full Stack (PHP) Developer. You should have 2+ years of experience working with multiple architectures and coding languages (front-end & back-end technologies). Apply now. Salary:INR 1,75,000 - 2,50,000 P.A Industry: IT-Software / Software Services Functional Area: IT Software - Application Programming , Maintenance Role Category:Programming & Design Role:Graphic/Web Designer Keyskills Web Technologies Web Application Full Stack Application Developer full stack web developer Desired Candidate Profile Please refer to the Job description above Education- UG: B.Tech/B.E. - Any Specialization, Diploma - Any Specialization PG:Post Graduation Not Required Doctorate:Doctorate Not Required Company Profile: Sinai Global Works on IT services related to Logistics Download PPT Photo 1 Â  View Contact Details\r\n', '131000000000', 'Bengaluru', '2', '1,75,000 - 2,50,000 P.A', '2022-10-13 16:20:55 +0000', 'IT Software - Application Programming', 'Software Development');
